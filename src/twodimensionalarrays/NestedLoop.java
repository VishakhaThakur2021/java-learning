...
public class NestedLoop {
  public static void main(String[] args) {
    ...
    int matchCounter = 0;
    //  outer loop header to iterate through the first array of seats
    for(int i = 0; i < seatsDayOne.length; i++) {

      // inner loop header to iterate through the second array of seats
      for(int j = 0; j < seatsDayTwo.length; j++) {

        //  conditional logic to check if an element in the first array matches an element in the second array
